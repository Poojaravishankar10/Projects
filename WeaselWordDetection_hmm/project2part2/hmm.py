...
#returns count of words per tag and total occurence of a tag, to be used for calculating P(w|t)
    ...
    for line in train_corpus:
        ...
        if proj_config.handle_unseen_with_pos :
    ...
    # counts
    #
    if proj_config.enable_unknown_word_handling == 1:
...
def tag_new_sentence( sentence, em_probs, trans_probs, ngram ):
    ...
    for i in range(1, sent_len):
        ...
        for tag in ['B', 'I', 'O']:
            ...
            if curr_column["word"] in em_probs[tag] :
            ...
            elif proj_config.handle_unseen_with_pos :
                try :
                ...
                if (curr_column["word"] in em_probs['B'] or
                    ...
                    #
                    if proj_config.enable_smoothing == 1 :
                    ...
                    # unknown word
                    #
                    if proj_config.enable_unknown_word_handling :
